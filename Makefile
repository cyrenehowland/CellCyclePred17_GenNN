...
CFLAGS := -march=$(ARCH) -g -O2 -fomit-frame-pointer -mfpmath=both -fopenmp -m64 -std=c++11
...
ifeq ($(OS),Windows_NT)
	...
	ifeq ($(UNAME_S),Darwin)
		...
		ifeq ($(lastword $(var)),arm64)
		  CFLAGS := -march=$(ARCH) -g -O2 -fomit-frame-pointer -fopenmp -m64 -std=c++11
		endif
	endif
endif
...
PhysiCell_custom_module_OBJECTS := custom.o custom_intracellular.o
...
custom_intracellular.o: ./custom_modules/custom_intracellular.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/custom_intracellular.cpp
